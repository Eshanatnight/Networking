...
public class PortMafia
{
    ...
    public void initAndRun(int startPortIndex, int endPortIndex)
    {
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            portMafia.initAndRun(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
        }
